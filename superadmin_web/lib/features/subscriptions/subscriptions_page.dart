                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(gym['gymName'] ?? '', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                            ),
                            _buildStatusBadge(gym['status'] ?? ''),
                          ],
                        ),
                        const SizedBox(height: 8),
                        Text('Owner: ${gym['ownerName'] ?? ''}', style: TextStyle(fontSize: 14, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.7))),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('MEMBERS', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.5))),
                                const SizedBox(height: 4),
                                Text((gym['activeMembers'] ?? 0).toString(), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                              ],
                            ),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                Text('REGISTERED', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.5))),
                                const SizedBox(height: 4),
                                Text('${regDate.month}/${regDate.day}/${regDate.year}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                              ],
                            ),
                          ],
                        ),
