...
class AppTheme {
  // Brand Colors
  static const Color primaryColor = Color(0xFFCFFF50); // Neon Lime Green
  static const Color primaryColorDark = Color(0xFFA5CC40);
  
  static const Color primaryColorLight = Color(0xFF1E293B); // Slate Dark Gray
  
  // Light Theme Colors
  static const Color backgroundLight = Color(0xFFF3F4F6); // Soft gray background as seen in design
  ...
  static TextTheme _buildTextTheme(TextTheme base, Color displayColor, Color bodyColor) {
    return GoogleFonts.interTextTheme(base).copyWith(
      ...
      titleMedium: base.titleMedium?.copyWith(color: displayColor, fontWeight: FontWeight.w500),
